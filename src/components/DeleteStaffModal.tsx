...
import type { DeleteStaffModalProps } from "../types/Staff";
import { deleteStaff } from "../service/staffService";
		...
		<div
			...
			<div className="bg-white rounded-xl shadow-xl w-full max-w-sm overflow-hidden">
				<div className="flex items-center justify-between px-6 py-4 border-b border-gray-100">
					<h2 className="text-lg font-bold text-gray-800">Hapus Staff</h2>
					<button
						onClick={onClose}
						disabled={loading}
				...
				<div className="p-6 space-y-4">
					<div className="flex gap-3">
						...
						<div>
							...
							<p className="text-sm font-semibold text-gray-900 mt-1">{staff.nama}</p>
							<p className="text-xs text-gray-400 mt-0.5">
								{staff.id_staff} · {staff.asal}
							</p>
